...
import DetailUserCst from "components/card/DetailUserCst";

const UserDetailCstModal = () => {
  ...
  return (
    <div className="bg-white w-full h-full rounded-md shadow-sm shadow-black">
      ...
      <DetailUserCst globalCtx={globalCtx} globalAct={globalAct} />
    </div>
  );
};

export default UserDetailCstModal;
