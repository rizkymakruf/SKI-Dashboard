    ...
    <div className="duration-500 bg-white border-orange-300 border-2 shadow-md w-full h-44 rounded-md p-4 flex flex-col justify-between hover:shadow-red-500 hover:scale-95">
      <div>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <p className="text-gray-600 text-sm font-semibold">Order</p>
        </div>
      </div>

      {/* <div className="flex items-center gap-x-1">
        <div className="ball_1 bg-red-500 w-4 h-4 rounded-full" />
        <div className="ball_2 bg-yellow-500 w-4 h-4 rounded-full" />
        <div className="ball_3 bg-green-500 w-4 h-4 rounded-full" />
      </div> */}

      <div className="flex flex-row items-center justify-between">
        <p className="text-sm font-bold">Total Order</p>
        <Link href={"/dashboard/manage_order"} passHref>
          <button
            className={
